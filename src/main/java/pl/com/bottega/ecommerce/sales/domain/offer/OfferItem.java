...
public class OfferItem {
    ...
    public OfferItem(String productId, BigDecimal productPrice, String productName, Date productSnapshotDate,
        ...
        this.discount = new Discount(new Money(discount), discountCause);

        Money discountValue = new Money(BigDecimal.valueOf(0));
        if (discount != null) {
    ...
    public boolean sameAs(OfferItem other, double delta) {
        ...
        BigDecimal acceptableDelta = max.multiply(BigDecimal.valueOf(delta / 100)).getAmount();

        return acceptableDelta.compareTo(difference.getAmount()) > 0;
    }
